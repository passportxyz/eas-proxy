...
import {MultiAttestationRequest, AttestationRequest, AttestationRequestData, IEAS, Attestation} from "@ethereum-attestation-service/eas-contracts/contracts/IEAS.sol";
...
contract GitcoinAttester {
    ...
    function addPassportWithSignature(
        ...
        return eas.multiAttest(getMultiAttestRequest(schema, passport));
        // return ret;
    }


    function addPassportWithSignatureDirect(
