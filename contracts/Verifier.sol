...
contract Verifier {
    ...
    bytes32 private constant PASSPORT_TYPEHASH = keccak256("Passport(Stamp[] stamps,address recipient)Stamp(string provider,string stampHash,string expirationDate)");
